...
import { readableStreamFromReader, writableStreamFromWriter } from "./stream.ts";
...
export class PCMStream extends FFmpegStream {
    constructor(path: string, extra: Record<string, string> = {}) {
        const args =  Object.entries(extra)
            .map(e => [ "-" + e[0], e[1] ])
            .flat()
